...
contract KlpBalance {
    ...
    constructor(IKlpManager _klpManager, address _stakedKlpTracker) public {
    ...
    function _transfer(
        ...
        require(klpManager.lastAddedAt(_sender).add(klpManager.cooldownDuration()) <= block.timestamp, "KlpBalance: cooldown duration not yet passed");
